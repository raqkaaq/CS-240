...
public class XmlStreamGenerationExample {

    public static void main(String [] args) {
        XmlStreamGenerationExample example = new XmlStreamGenerationExample();
    ...
    private void printUsage() {
        System.out.println("USAGE: java XmlStreamGenerationExample outputFilePath");
    }
