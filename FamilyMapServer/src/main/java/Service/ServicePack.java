...
public class ServicePack {
    ...
    //generate a random id, personid,eventid, or authtoken
    public static String createRandomString(){
        return UUID.randomUUID().toString();
    }
    //generate 2 random user events
    ...
    //Fill the generations with the correct information and updated personids
    public static void fillGenerations(Person orphan, int numGenerations, int birthYear, PersonDAO pd, EventDAO ed, FillData fillData) throws DataAccessException {
        ...
        numGenerations--;
        if(numGenerations > 0) { //recurse through the rest of the generations
    ...
    //fix the spouse personid for the mother and father and add marriage event
